        ...
        <div className={styles.nutritionLabel}>
            ...
            <div className={styles.row}>
                <span>
                    ...
                    {Math.round(nutrients.FAT.quantity / servings)}
                    {nutrients.FAT.unit}
                </span>
                <span>
                    <strong>
                        {Math.round(daily.FAT.quantity / servings)}%
                    </strong>
                </span>
            </div>
            <div className={styles.row}>
                <span className={styles.indented}>
                    Saturated Fat{" "}
                    {Math.round(nutrients.FASAT.quantity / servings)}
            ...
            <div className={styles.row}>
                <span className={styles.indented}>
                    Polyunsaturated Fat{" "}
                    {Math.round(nutrients.FAPU.quantity / servings)}
                    {nutrients.FAPU.unit}
                </span>
            </div>
            <div className={styles.row}>
                <span className={styles.indented}>
                    Monounsaturated Fat{" "}
                    {Math.round(nutrients.FAMS.quantity / servings)}
                    {nutrients.FAMS.unit}
                </span>
            </div>
            <div className={styles.row}>
                <span className={styles.indented}>
                    <i>Trans</i> Fat{" "}
                    {Math.round(nutrients.FATRN.quantity / servings)}
            ...
            <div className={styles.row}>
                <span>
                    ...
                    {Math.round(nutrients.CHOLE.quantity / servings)}
                    {nutrients.CHOLE.unit}
                </span>
                <span>
                    <strong>
                        {Math.round(daily.CHOLE.quantity / servings)}%
                    </strong>
                </span>
            </div>
            <div className={styles.row}>
                ...
                <span>
                    <strong>{Math.round(daily.NA.quantity / servings)}%</strong>
                </span>
            </div>
            <div className={styles.row}>
                <span>
                    <strong>Total Carbohydrates</strong>{" "}
                    {Math.round(nutrients.CHOCDF.quantity / servings)}
                    {nutrients.CHOCDF.unit}
                </span>
                <span>
                    <strong>
                        {Math.round(daily.CHOCDF.quantity / servings)}%
                    </strong>
                </span>
            </div>
            <div className={styles.row}>
                <span className={styles.indented}>
                    Dietary Fiber{" "}
                    {Math.round(nutrients.FIBTG.quantity / servings)}
            ...
            <div className={styles.row}>
                <span className={styles.indented}>
                    Total Sugars{" "}
                    {Math.round(nutrients.SUGAR.quantity / servings)}
                    {nutrients.SUGAR.unit}
                </span>
            </div>
            <div className={styles.row}>
                <span className={styles.doubleIndented}>
                    includes{" "}
                    {Math.round(nutrients["SUGAR.added"].quantity / servings)}
                    {nutrients["SUGAR.added"].unit} added sugars
                </span>
            </div>
            <div className={styles.row}>
                <span className={styles.indented}>
                    Sugar alcohol{" "}
                    {Math.round(nutrients["Sugar.alcohol"].quantity / servings)}
                    {nutrients["Sugar.alcohol"].unit}
                </span>
            </div>
            <div className={styles.row}>
                <span>
                    <strong>Protein</strong>{" "}
                    {Math.round(nutrients.PROCNT.quantity / servings)}
                    {nutrients.PROCNT.unit}
                </span>
                <span>
                    <strong>
                        {Math.round(daily.PROCNT.quantity / servings)}%
                    </strong>
                </span>
            </div>
            ...
            <div className={styles.micro}>
                <div className={styles.row}>
                    <span>Vitamin A</span>
                    <span>
                        {Math.round(daily.VITA_RAE.quantity / servings)}%
                    </span>
                </div>
                <div className={styles.row}>
                    <span>Vitamin C</span>
                ...
                <div className={styles.row}>
                    <span>
                        Water {Math.round(nutrients.WATER.quantity / servings)}
                        {nutrients.WATER.unit}
                    </span>
                </div>
            </div>
        </div>
